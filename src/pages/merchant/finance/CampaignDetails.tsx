          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6 mb-4">
            <div className="flex items-start gap-2 sm:gap-3 flex-1 min-w-0">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2 text-xs sm:text-sm text-primary-600 dark:text-primary-400 mb-1">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-4 sm:p-6 shadow-sm">
              <div className="flex items-center gap-2 mb-4">
                <Globe className="text-primary-600 flex-shrink-0" size={20} />
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-lg font-bold shadow-md hover:shadow-lg transition-all text-sm"
              >
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-4 sm:p-6 shadow-sm">
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-3">
                <button className="flex items-center justify-center px-3 py-3 bg-primary-600 hover:bg-primary-700 text-white rounded-lg transition-colors">
                  <Users size={20} />
                </button>
                ...
                <button className="flex items-center justify-center px-3 py-3 bg-primary-500 hover:bg-primary-600 text-white rounded-lg transition-colors">
                  <Mail size={20} />
                </button>
              </div>
            </div>
